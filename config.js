module.exports = {
  ...
  website: {
    callback: "https://discordev.cf/callback",
  ...
  server: {
    ...
    roles: {
      yonetici: "929837700662583296", // Team roleid
      ...
      community: "928295233370861608", // Community Role id
      ...
      administrator: "938101978830090360", // Team Role id Again
      moderator: "938101978830090360", // bot tester Role id
      moderatorrole: "938101978830090360", // Server Moderator Role id
      profile: {
